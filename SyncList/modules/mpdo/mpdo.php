...
namespace SyncListModule\mPDO;
/**
 * Class mPDO
 * @package SyncListModule\mPDO
 *
 * @property \PDO $link
 */
class mPDO extends \SyncListModule
{
    public $pdo = null;
    
    private $statement = null;
    
    public function __construct(\SyncListKernel $kernel, \stdClass $config, $module_path, $hostname, $username, $password, $database, $port = "3306")
    {
